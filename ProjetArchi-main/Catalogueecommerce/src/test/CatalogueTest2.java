...
//		cat.clear();
	...
	public void testAddProduitIProduit_deuxFoisProduitMemeNomNonConsecutif() {
		...
		assertFalse("ajout deux produits avec mÃªme nom non consécutif", cat.addProduit(p3));
	}
	...
	public void testGetNomProduits_unProduit() {
		String[] tab = { "Mars" };
		cat.addProduit("Mars", 10, 1);
		assertArrayEquals("récupÃ¨re nom produits avec un seul produit", tab, cat.getNomProduits());
	}
	...
	public void testGetNomProduits_unProduitAvecNomEspacesAuDebut() {
		String[] tab = { "Mars" };
		cat.addProduit(" Mars", 10, 1);
		assertArrayEquals("récupÃ¨re nom produit avec espace debut ; les espaces au début ne doivent pas Ãªtre stockés",
	...
	public void testGetNomProduits_unProduitAvecNomEspacesALaFin() {
		String[] tab = { "Mars" };
		cat.addProduit("Mars ", 10, 1);
		assertArrayEquals("récupÃ¨re nom produit avec espace fin ; les espaces Ã  la fin ne doivent pas Ãªtre stockés",
				tab, cat.getNomProduits());
	}
	...
	public void testGetNomProduits_unProduitAvecNomEspacesAuMilieu() {
		...
		assertArrayEquals("récupÃ¨re nom produit avec des espace au milieu", tab, cat.getNomProduits());
	}
	...
	public void testGetNomProduits_unProduitAvecNomTabulationsAuDebut() {
		...
		cat.addProduit("	Mars", 10, 1);
		assertArrayEquals(
				"récupÃ¨re nom produit avec tabulation debut ; les tabulations au début ne doivent pas Ãªtre stockés",
				tab, cat.getNomProduits());
	}
	...
	public void testGetNomProduits_unProduitAvecNomTabulationsALaFin() {
		...
		cat.addProduit("Mars	", 10, 1);
		assertArrayEquals(
				"récupÃ¨re nom produit avec tabulation fin ; les tabulations Ã  la fin ne doivent pas Ãªtre stockés", tab,
				cat.getNomProduits());
	}
	...
	public void testGetNomProduits_unProduitAvecNomTabulationsAuMilieu() {
		...
		cat.addProduit("Kit	Kat", 10, 1);
		assertArrayEquals(
				"récupÃ¨re nom produit avec des tabulations au milieu ; les tabulations au milieu doivent Ãªtre remplacées par des espaces",
				tab, cat.getNomProduits());
	}
	...
	public void testGetNomProduits_deuxProduits() {
		...
		cat.addProduit("Mars", 10, 1);
		cat.addProduit("Treets", 10, 1);
		assertArrayEquals("récupÃ¨re nom de deux produits", tab, cat.getNomProduits());
	}
	...
	public void testGetNomProduits_plusieursProduitsInseresOrdreAlphabetique() {
		...
		cat.addProduit("Raider", 12, 2);
		cat.addProduit("Treets", 10, 1);
		assertArrayEquals("récupÃ¨re nom de plusieurs produits ajoutés dans ordre alphabétique", tab,
				cat.getNomProduits());
	}
	...
	public void testGetNomProduits_plusieursProduitsInseresOrdreAleatoire() {
		...
		assertArrayEquals(
				"récupÃ¨re nom de plusieurs produits ajoutés dans ordre aléatoire (doivent Ãªtre retournés dans l'ordre alphabétique)",
				tab, cat.getNomProduits());
	}
	...
	public void testMontantTotalTTC_avecVirgule_AvecArrondiInferieur_TroisChiffresApresLaVirgule() {
		...
		assertEquals("montant TTC avec virgule ; 135.192 doit Ãªtre arrondi Ã  135.19", 135.19, cat.getMontantTotalTTC(),
				0);
	}
	...
	public void testMontantTotalTTC_avecVirgule_AvecArrondiSuperieur_TroisChiffresApresLaVirgule() {
		...
		assertEquals("montant TTC avec virgule ; 135.228 doit Ãªtre arrondi Ã  135.23", 135.23, cat.getMontantTotalTTC(),
				0);
	}
	...
	public void testToString_CatalogueAvecDesProduits_TotalAvecDeuxChiffresApresVirgule() {
		...
		assertEquals("toString catalogue avec un total de deux chiffres aprÃ¨s virgule", resultatAttendu,
				cat.toString());
	}
	...
	public void testToString_CatalogueAvecDesProduits_TotalAvecTroisChiffresApresVirguleArrondiInferieur() {
		...
		assertEquals(
				"on affiche que deux chiffres aprÃ¨s la virgule dans le prix unitaires TTC, mais le montant total TTC du catalogue est calculé avec les prix unitaires TTC non arrondis",
	...
	public void testClear() {
		...
		cat1.addProduit("Mars",1,5);
		cat1.addProduit("Kinder",5,6);
		cat1.clear();
		assertEquals(cat1.getListProduit(),cat2.getListProduit());
	}
